...
public class CriacaoDaoService {

	public static void criarDaoService (ClsModel clsModel, String caminhoEspelhado) throws Exception {
		...
		if (nomeInterface != null && nomeInterface.endsWith(".cls")) {
			...
			nomeInterface = nomeInterface+"Dao";
		}
